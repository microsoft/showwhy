...
def orchestrator_function(context: df.DurableOrchestrationContext):
    ...
    identify_estimand_result = yield context.call_activity("IdentifyEstimandActivity", data)

    cells = yield context.call_activity("IdentifyEstimandNotebookCellsActivity", {
        **data
    })
