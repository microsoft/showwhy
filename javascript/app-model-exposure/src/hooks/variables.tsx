...
import { useHandleKeyPress } from './useHandleKeyPress.js'
import { useHandleOnBlur } from './useHandleOnBlur.js'
...
export function useHasLevel(factor?: CausalFactor | Definition): boolean {
	return useMemo(
		() => !!(factor && Object.prototype.hasOwnProperty.call(factor, 'level')),
		[factor],
	)
}
