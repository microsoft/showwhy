...
class ShowWhyDurableOrchestrationClient(df.DurableOrchestrationClient):
    def __init__(self, *args, **kwargs):
        super(ShowWhyDurableOrchestrationClient, self).__init__(*args, **kwargs)
    ...
    def create_http_management_payload(self, instance_id: str) -> Dict[str, str]:
        ...
        http_management_payload = super(
            ShowWhyDurableOrchestrationClient, self
        ).create_http_management_payload(instance_id)
    ...
    def create_check_status_response(
        ...
        http_management_payload = self.secure_management_apis(http_management_payload)
