...
from shared_code.inference.inference import join_results
...
def main(body: Dict):
    ...
    file_name = storage.write_output(session_id, str(
        uuid.uuid4()), results_df, file_type='partial', extension='csv')
